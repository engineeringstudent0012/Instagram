...
function Post({ id, username, userImag, img, caption }) {
  ...
  return (
    <div className="bg-white my-7 border rounded-sm">
      ...
      <div className="flex items-center p-5">
        <img
          src={userImag} className="rounded-full h-12 w-12 object-contain border p-1 mr-3"
          alt="" />
          ...
          {comments.map(comment => (
            <div key={comment.id} className="flex items-center space-x-2 mb-3">
              <img
                ...
                alt="" className="h-7 rounded-full " />
